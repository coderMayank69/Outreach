...
class PersonalEmailAutomation:
    ...
    def setup_gmail_credentials(self):
        ...
        self.gmail_password = getpass.getpass("Enter your Gmail App Password: ").strip()
        ...
        if save_creds == 'y':
            try:
                ...
                os.chmod('gmail_config.txt', 0o600)
            ...
            try:
                ...
                for line in lines:
                    ...
                    if line.startswith('EMAIL='):
                        ...
                        self.your_name = line.split('=', 1)[1].strip()
    ...
    def get_personal_email_templates(self):
        ...
        template1 = {
            'subject': "Loved your recent video!",
            'body': f"""Hi,
...
I'm a thumbnail designer from India, and I've been helping creators increase their click-through rates. I can make a quick sample for one of your videos.
...
P.S. If thumbnails aren't a priority for you right now, no worries at all - just let me know and I won't bother you again."""
        ...
        template2 = {
            'subject': "Quick suggestion for your channel",
            'body': f"""Hey,
